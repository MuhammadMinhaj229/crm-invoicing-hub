  ...
  return (
    <div id="top" className="min-h-screen bg-background text-foreground">
      <main>
            ...
            <section className="relative overflow-hidden border-b border-border">
              <div className="mx-auto grid max-w-7xl items-center gap-6 px-5 py-10 sm:py-14 md:min-h-[660px] md:grid-cols-[0.92fr_1.08fr] md:gap-8 md:py-16">
                ...
                <div className="relative order-2 md:order-none md:col-start-2 md:row-span-2 md:row-start-1 md:-mr-16 md:self-center">
                  ...
                  <img
                    ...
                    alt={str(
                      hero,
                      "imageAlt",
                      "A Gulf-based family member coordinating trusted help for parents in India",
                    )}
                    width={1600}
                    height={1008}
                    fetchPriority="high"
                ...
                <div className="relative z-10 order-3 md:col-start-1 md:row-start-2 md:self-start">
                  ...
                  {settings.websiteAppearance.showHeroHighlights ? (
          ...
          <div className="mx-auto max-w-3xl px-5 text-center">
            ...
            <h2 className="site-display mt-3 font-display text-3xl font-extrabold leading-tight md:text-4xl">
              {str(
                promise,
                "title",
                "You can't always be there for your parents in India. But we can.",
              )}
            </h2>
          ...
          <div className="mx-auto max-w-7xl px-5">
            <div className="max-w-2xl">
              <p className="text-xs font-extrabold uppercase text-primary">
                Practical help, handled properly
              </p>
            ...
            {settings.websiteAppearance.sectionStyle === "grid" ? (
                      ...
                      <div className="mt-5 divide-y divide-border">
                        {group.items.map((item) => (
                          <div key={item.title} className="py-5 first:pt-0 last:pb-0">
                            <h3 className="site-display font-display text-2xl font-bold text-foreground">
                              {item.title}
                            </h3>
        ...
        {/* How it works */}
        {settings.websiteAppearance.showProcessSection ? (
        ...
        <section className="py-16">
          <div className="mx-auto max-w-6xl px-5">
            <div className="rounded-lg bg-foreground px-8 py-12 text-background md:px-12">
              ...
              <p className="mt-3 max-w-2xl text-background/80">{str(ctaSection, "subtitle")}</p>
              <a
